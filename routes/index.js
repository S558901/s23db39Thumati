...
router.get('/', function (req, res) {
  res.render('index', { title: 'telephones App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'telephones App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'telephones App Login', user: req.user });
});
